---
isDraft: false
featureIcon: { url: 'images/posts/feature-icon/chaining-operator.svg', alt: '一個點和問號(可選串聯)符號' }
title: 'Javascript Optional Chaining Operator'
titleTC: '使用可選串聯存取不確定是否存在的資料'
excerpt: '學習可選串聯語法可以讓我們安全的存取某個嵌套的物件屬性，就算其屬性並不存在也不會導致錯誤。 '
category: 'JavaScript'
tags: ['語法', 'ES2020']
