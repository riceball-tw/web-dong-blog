---
isDraft: false
featureIcon: { url: 'images/posts/feature-icon/check-circle.svg', alt: '一個勾在圈圈內的符號' }
title: 'Setting Up ESLint and Prettier in Astro'
titleTC: '為 Astro 設置 ESLint 與 Prettier'
excerpt: '本篇文章有詳細的教學範例引導你在 Astro 中安裝 ESLint 與 Prettier 套件，並且支援 TypeScript 與 VSCode 提示'
category: '教學'
tags: ['Astro']
