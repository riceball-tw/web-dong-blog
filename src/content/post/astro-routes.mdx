...
title: 'Day12 - Astro Series: Routes'
titleTC: 'Astro 系列文第十二日：基礎路由'
excerpt: '你也大概猜到了，只要元件放置在 src/pages/ 之內就會自動的成為 Astro 的頁面，在本章節會更細緻的介紹關於 Astro 的路由設置。'
category: 'Astro'
tags: ['系列文']
...
<Figure
  width="1200"
  height="600"
  src="images/posts/ithome-astro/thumbnail/day12-routes.webp"
  alt="一個漂亮的漸層背景上面有一句標題：「基礎路由」"
/>
