...
title: 'Day14 - Astro Series: Image Optimization'
titleTC: 'Astro 系列文第十四日：圖片最佳化'
excerpt: '通常文件會伴隨著圖片，而圖片可以佔據一個頁面絕大多數的運算資源與流量！你會希望圖片能夠被好好處理避免它們壓垮整個網站的體驗，Astro 預設自帶相關的元件與方法幫助你處理這些事務。'
category: 'Astro'
tags: ['系列文']
...
<Figure
  width="1200"
  height="600"
  src="images/posts/ithome-astro/thumbnail/day14-image-optimization.webp"
  alt="一個漂亮的漸層背景上面有一句標題：「圖片最佳化」"
/>
