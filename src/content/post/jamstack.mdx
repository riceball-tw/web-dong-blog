---
isDraft: false
featureIcon: { url: 'images/posts/feature-icon/jamstack.svg', alt: 'Jamstack 符號' }
title: 'What is Jamstack?'
titleTC: '給初學者的 Jamstack 介紹'
excerpt: '你可能在近期會很常聽到 Jamstack 這個詞彙，簡單來說它是一種現代建構網頁應用的方式。藉由這篇入門文章你可以了解：為什麼需要它？以及如何實踐這項技術。'
category: '模式'
tags: ['概念', 'Jamstack']
