---
isDraft: false
featureIcon: { url: 'images/posts/feature-icon/style.svg', alt: '色票符號' }
title: 'Build Product From Scratch - Tokens'
titleTC: '紀錄如何從頭打造數位產品 - 設計令牌篇'
...
<Figure width="500" height="234" src="images/posts/build-product-from-scratch-tokens/token.webp" alt="Token 範例" />
