...
excerpt: '撰寫網站最終還是要回歸到易於維護，能不能不需要接觸程式，只需透過編寫文件就能更改頁面內容呢？也就是將內容與版面、邏輯做分離。本章節我們將會學習 Markdown 與 MDX 來達成這件事。'
category: 'Astro'
tags: ['系列文']
...
<Figure
  width="1200"
  height="600"
  src="images/posts/ithome-astro/thumbnail/day13-markdown-and-mdx.webp"
  alt="一個漂亮的漸層背景上面有一句標題：「Markdown 與 MDX」"
/>
...
<Figure
  width="2000"
  height="943"
  src="images/posts/ithome-astro/day13-markdown-and-mdx/markdown-cheatsheet.webp"
  alt="Markdown 懶人包"
/>
...
<Figure
  width="1100"
  height="504"
  src="images/posts/ithome-astro/day13-markdown-and-mdx/mdx-chart.webp"
  alt="左邊是一段 MDX 代碼，右邊是一個由 MDX 產生的畫面"
/>
