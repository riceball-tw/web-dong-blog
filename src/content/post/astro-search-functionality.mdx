...
excerpt: '前面透過建立靜態端點實作了自己的 RSS Feed 算是一個簡單的練習起步，這次更進一步透過建立整個集合的資料來完成「集合文章搜尋功能」。'
category: 'Astro'
tags: ['系列文']
...
<Figure
  width="1200"
  height="600"
  src="images/posts/ithome-astro/thumbnail/day20-search-functionality.webp"
  alt="一個漂亮的漸層背景上面有一句標題：「實作搜尋功能」"
/>
