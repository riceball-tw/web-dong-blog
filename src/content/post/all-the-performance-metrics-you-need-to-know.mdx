...
titleTC: '學習所有 Google 提出衡量網頁效能的指標！ feat. TTFB, FCP, LCP, FID, CLS, TTI, TBT'
excerpt: '本篇文章挑戰用自己的方式去理解並解釋所有 Google 提出網頁體驗相關的指標，陣容豪華絕對空前精彩。'
category: '教學'
tags: ['網頁效能']
...
<Figure
  width="700"
  height="230"
  src="images/posts/all-the-performance-metrics-you-need-to-know/ttfb.svg"
  alt="良好的 TTFB 數值建議在 800 毫秒以內，在 1800 毫秒以上則視為差勁，在此之間則需要改進"
/>
...
<Figure
  width="700"
  height="230"
  src="images/posts/all-the-performance-metrics-you-need-to-know/fcp.svg"
  alt="良好的 FCP 數值建議在 1.8 秒以內，在 3 秒以上則視為差勁，在此之間則需要改進"
/>
...
<Figure
  width="700"
  height="230"
  src="images/posts/all-the-performance-metrics-you-need-to-know/lcp.svg"
  alt="良好的 LCP 數值建議在 2.5 秒以內，在 4 秒以上則視為差勁，在此之間則需要改進"
/>
...
<Figure
  width="700"
  height="230"
  src="images/posts/all-the-performance-metrics-you-need-to-know/fid.svg"
  alt="良好的 FID 數值建議在 100 豪秒以內，在 300 毫秒以上則視為差勁，在此之間則需要改進"
/>
...
<Figure
  width="700"
  height="230"
  src="images/posts/all-the-performance-metrics-you-need-to-know/cls.svg"
  alt="良好的 CLS 數值建議在 0.1 以內，在 0.25 以上則視為差勁，在此之間則需要改進"
/>
...
<Figure
  width="700"
  height="230"
  src="images/posts/all-the-performance-metrics-you-need-to-know/tti.svg"
  alt="良好的 TTI 數值建議在 3.8 秒以內，在 7.3 秒以上則視為差勁，在此之間則需要改進"
/>
...
<Figure
  width="700"
  height="230"
  src="images/posts/all-the-performance-metrics-you-need-to-know/tbt.svg"
  alt="良好的 TBT 數值建議在 200 豪秒以內，在 600 豪秒以上則視為差勁，在此之間則需要改進"
/>

測量 FCP 與 TTI 之間的時間差，也就是**測量網頁在載入過程中被堵塞的時間**，從這項指標中主要可以了解網頁的互動性，越好的 TBT 越能說服用戶網頁「[是否可用](#usable)」。
