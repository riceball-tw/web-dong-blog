...
<p class="codepen" data-height="300" data-default-tab="result" data-slug-hash="vYqwxpa" data-pen-title="Real use case of intersection observer: Table of Contents" data-preview="true" data-editable="true" data-user="riecball" style="height: 300px; box-sizing: border-box; display: flex; align-items: center; justify-content: center; border: 2px solid; margin: 1em 0; padding: 1em;">
  <span>See the Pen <a href="https://codepen.io/riecball/pen/vYqwxpa">
  Real use case of intersection observer: Table of Contents</a> by Riceball (<a href="https://codepen.io/riecball">@riecball</a>)
