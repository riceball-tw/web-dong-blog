---
isDraft: false
featureIcon: { url: 'images/icons/search.svg', alt: '搜尋符號' }
icon: { name: 'material-symbols:manage-search-rounded', title: '文字片段與放大鏡符號' }
title: 'Build a book-finder using JavaScript'
titleTC: 'JavaScript 五個步驟製作搜尋功能'
excerpt: '搜尋列是普遍存儲資料於 HTML 中最常用的方式之一，讓我們學會如何使用它。本篇文章將會練習從無到有包含介面製作一個搜尋框，可以輸入結果並比對現有資料顯示關聯的內容，是一個非常適合 JavaScript 新手的一道實用練習題目。'
category: '實作'
tags: ['簡單題']
