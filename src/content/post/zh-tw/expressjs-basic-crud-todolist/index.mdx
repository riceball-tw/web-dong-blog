...
這次實作專案：[in-memory-todo](https://github.com/riceball-tw/in-memory-todo) 的檔案有放上 GitHub，後續額外實作了前端的部分。

如果對前端感興趣可以參考我的另一篇文章：[JavaScript 五個步驟製作代辦事項](https://www.webdong.dev/post/javascript-todo-list-exercise/) 基本就是在此基礎上接上後端的資料，並更動迴避了一些 [XSS](https://www.webdong.dev/post/xss-for-web-developer/) 的隱患。
