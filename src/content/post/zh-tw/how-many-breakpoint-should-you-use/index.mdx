---
isDraft: false
icon: { name: 'material-symbols:photo-size-select-small-rounded', title: '圖片縮放符號' }
subHeadline: 'How many breakpoint should you use? The less the better.'
headline: '製作響應式網頁需要多少尺寸版本？三個論點說服你越少越好。'
excerpt: '我既設計網頁也開發網頁，並且在過去幾年經驗中總結發現設計與開發配合上容易遇到的問題像是：我需要繪製多少種尺寸的網頁？我需要替網頁設置多少個斷點？這篇文章我分享自己身為設計者與開發者的經歷以及你為何應該使用越少的斷點來製作響應式網頁越好。'
category: 'CSS'
tags: ['RWD']
...
![許多常見裝置尺寸重疊的示意圖](./screen-size.webp '現今網頁已經有太多不同尺寸與解析度的裝置，每一個方框就代表一種市面上的裝置尺寸')
...
<Info type="info">
  單純的平面稿件無法完整表達響應式內容，但現代 UI 設計軟體像是 Figma 就有考量到這樣的問題並推出 [Auto
