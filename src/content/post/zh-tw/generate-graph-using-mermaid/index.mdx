...
icon:
  ...
  title: 圖表圖示
subHeadline: Generate graph using Mermaid
headline: 使用 Mermaid 透過文字快速生成圖表
excerpt: 近期工作順代研究到使用 Mermaid 來快速生成圖表，這是一個很方便的工具，可以快速生成各種圖表，例如流程圖、心智圖、圓餅圖……等，你能想到的圖表基本都有支援。大致紀錄一下選擇這項技術的原因以及使用上的心得。
category: Share
