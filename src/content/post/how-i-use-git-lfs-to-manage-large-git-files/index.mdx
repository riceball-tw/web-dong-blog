...
title: 'How I Use Git LFS to Manage Large Git Files?'
titleTC: '我如何使用 Git LFS 來託付大型 Git 檔案？'
...
試想一張 `1MB` 的圖片只要改動了 10 次，Git 就會儲存 10 個版本的圖片也就是 `10 MB` 到儲存庫當中！這樣會導致效能問題、浪費儲存空間、耗費網路資源……等問題，而這次介紹的 Git Large File Storage 是 Git 的擴充，專門用於解決以上問題。
