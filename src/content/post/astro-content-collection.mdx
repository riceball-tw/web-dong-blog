...
excerpt: '除了定義資料在元件中、在 `src` 中 `import` 進來或者是 `fetch` 遠端資料之外有其他撰寫內容的方式嗎？有的！'
category: 'Astro'
tags: ['系列文']
...
<Figure
  width="1200"
  height="600"
  src="images/posts/ithome-astro/thumbnail/day16-content-collection.webp"
  alt="一個漂亮的漸層背景上面有一句標題：「內容集合」"
/>
