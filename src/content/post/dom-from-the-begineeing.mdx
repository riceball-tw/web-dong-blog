---
isDraft: false
featureIcon: { url: 'images/posts/feature-icon/mediation.svg', alt: '節點符號' }
...
<Figure width="651" height="351" src="images/posts/dom-from-the-begineeing/dom-tree.webp" alt="DOM 的樹狀圖表" />
...
<Info type="success">
  ...
  <Figure
    width="300"
    height="300"
    src="images/posts/dom-from-the-begineeing/cheat-sheet-demo.webp"
    alt="DOM 的樹狀圖表"
    href="images/posts/dom-from-the-begineeing/dom-cheatsheet-full.webp"
    loading="lazy"
  />
</Info>
