...
excerpt: '藉由本系列文章將持續 30 日不間斷的更新帶領你上手它！今日介紹如何從頭建構一個專案並且了解資料夾結構。'
category: 'Astro'
tags: ['系列文']
...
<Figure
  width="1200"
  height="600"
  src="images/posts/ithome-astro/thumbnail/day3-hello-astro-world.webp"
  alt="一個漂亮的漸層背景上面有一句標題：「建構新專案」"
/>
