---
isDraft: false
featureIcon: { url: 'images/posts/feature-icon/wrench-circle.svg', alt: '一個板手在圈圈內的符號' }
title: "Let's building a Portfolio using Astro.js"
titleTC: '製作個人前端作品集 - 實作篇'
excerpt: 'Astro 作為一個靜態內容為主的生產器非常適合用於打造靜態網頁，這次我將用自己的作品集為案例教你打造一個實際的靜態網站。'
category: '教學'
tags: ['Astro']
...
<Info type="warning">
  本篇專案範例使用 Tailwind 作為撰寫 CSS 的方式，可以參考之前的文章：[不需要學 Tailwind 也可以用 Tailwind](/post/use-tailwind-without-learning-it)，選擇合適自己的方式即可。
</Info>
...
<Figure
  width="600"
  height="300"
  src="images/posts/lets-build-a-portfolio-with-astro/blank-setting.webp"
  alt="一個空白的頁面，有一個 Astro 的標題"
/>
...
在Astro.js 中創建頁面非常的簡單，它是基於檔案的路由，可以直接撰寫 `.astro`、`.html` 、 `.mdx` 或 `.md` 檔案放置到資料夾中，生成時就會依照檔案的名稱與位置產生出對應的靜態頁面，舉例來說：
  ...
  <main class="md:min-h-screen min-h-auto">
    ...
    <section class="mb-16">
      ...
      <div style="background-color: black;" class="aspect-video flex justify-center mx-4 rounded-lg">
        <video class="w-full h-full" width="720" height="540" autoplay loop muted playsinline poster="">
...
<Figure
  width="1300"
  height="1270"
  src="images/posts/lets-build-a-portfolio-with-astro/home.webp"
  alt="一個空白的頁面，有一個 Astro 的標題"
/>