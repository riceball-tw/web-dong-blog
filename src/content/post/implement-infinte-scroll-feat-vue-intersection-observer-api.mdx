...
excerpt: '近期工作剛好接觸很多介面開發的部分，其中一個需求實作「無限滾動加載功能」，當使用者滾動到頁面底部時，會自動加載更多的資料，讓使用者不用點擊按鈕就能瀏覽更多的資料，就像是自動版的加載按鈕。'
category: 'Vue'
tags: ['實作']
...
近期工作剛好接觸很多介面開發的部分，其中一個需求實作「無限滾動加載功能」，這是一種常見的加載策略出現在 Facebook、Instagram、Twitter、Pinterest……等主流網站，當使用者滾動到頁面底部時，會自動加載更多的資料，讓使用者不用點擊按鈕就能瀏覽更多的資料，就像是自動版的加載按鈕。

<Figure
  width="1200"
  height="600"
  src="images/posts/implement-infinte-scroll-feat-vue-intersection-observer-api/loading-strategy.webp"
  alt="頁籤、無限滑動、加載按鈕範例"
/>
...
<Figure
  width="1200"
  height="650"
  src="images/posts/implement-infinte-scroll-feat-vue-intersection-observer-api/result.webp"
  alt="程式結果呈現"
/>
