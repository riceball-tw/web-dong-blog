---
isDraft: false
featureIcon: { url: 'images/posts/feature-icon/assignment.svg', alt: '文件符號' }
title: 'Everything you need to know about HTML Form'
titleTC: '簡單明確的了解 HTML 表單使用方式'
excerpt: '很多時候都會忽略掉 HTML 本身就有很好的支援輸入控制與提交，讓我們來了解怎麼使用 HTML 表單製作一個無障礙且語意化的輸入表單。'
category: 'HTML'
tags: ['語意化']
...
<form>
  <input class="bg-primary-100 dark:bg-primary-900" type="text" placeholder="input 標籤範例……"/>
</form>
...
<form>
  <input class="bg-primary-100 dark:bg-primary-900" type="text" value="我是預設文字"/>
</form>
...
<form class="flex gap-4">
  <input class="bg-primary-100 dark:bg-primary-900" type="text" placeholder="嘗試不輸入就直接提交" required/>
  <button type="submit" class="underline">提交按鈕</button>
</form>
...
<form class="flex gap-4">
  <input class="bg-primary-100 dark:bg-primary-900" type="text" placeholder="禁止輸入" disabled/>
  <button type="submit" class="underline" disabled>提交按鈕（禁止提交）</button>
</form>
...
<form class="flex flex-col gap-4">
  <label class="flex gap-4">
    <span>電子信箱</span>
    <input  class="bg-primary-100 dark:bg-primary-900" type="email" placeholder="請輸入電子信箱"/>
  </label>
  <label class="flex gap-4">
    <span>年齡</span>
    <input class="bg-primary-100 dark:bg-primary-900" type="number" min="1" placeholder="請輸入年齡"/>
  </label>
  <label class="flex gap-4">
    <span>密碼</span>
    <input  class="bg-primary-100 dark:bg-primary-900" type="password" placeholder="請輸入密碼"/>
  </label>
  <label class="flex gap-4">
    <span>檔案</span>
    <input  class="bg-primary-100 dark:bg-primary-900" type="file" placeholder="請選擇檔案"/>
  </label>
...
<form class="flex flex-col gap-4">
  <textarea class="bg-primary-100 dark:bg-primary-900" rows="5" cols="50" placeholder="請輸入文字"></textarea>
  <button type="submit" class="underline">提交按鈕</button>
</form>
