...
<ul style="list-style-image: url(/images/posts/feature-icon/release-alert.svg);">
  <li><a href="#ttfb">TTFB</a>：由於每請求一個頁面就會需要伺服器重新生成，引此勢必會更久</li>
  <li>
...
<ul style="list-style-image: url(/images/posts/feature-icon/release-alert.svg);">
  <li>留意 <a href="#fcp">FCP</a>、<a href="#lcp">LCP</a>、<a href="#tti">TTI</a>、<a href="#fid">FID</a>：由於需要等待 JavaScript 加載，因此首次內容繪製的時間會更久</li>
</ul>
