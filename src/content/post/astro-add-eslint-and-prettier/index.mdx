...
excerpt: '我喜歡使用自動化的工具來為專案的代碼提供錯誤檢查與整理，因此使用 ESLint 與 Prettier 讓撰寫的代碼更一致無錯，還有額外添加 TypeScript 的檢查與 VSCode 提示。本篇文章將帶你認識我如何替自己的 Astro 部落格添加 ESLint 與 Prettier。'
category: 'Astro'
tags: ['系列文']
publishDate: 2023-10-09
---

![一個漂亮的漸層背景上面有一句標題：「添加 ESLint 與 Prettier 」](./day24-add-eslint-and-prettier.webp)
