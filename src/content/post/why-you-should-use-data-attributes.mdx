...
excerpt: 'data 屬性是一個正式存儲資料於 HTML 的作法，將資訊儲存在 HTML 標籤屬性上，使 JavaScript 與 CSS 都能讀取得到元素的資料，同時也有一些應該特別注意的常見的錯誤範例也會在本文中展示。'
category: 'HTML'
tags: ['語法']
...
data 屬性是一個正式存儲資料於 HTML 的作法，讓 Javascript 與 CSS 都能讀取得到元件的資料，直接把資料置於客戶端的元件中。
